...
namespace PawShelter.Accounts.Infrastructure.Migrations
{
    ...
    [Migration("20241122163253_Initial")]
            ...
            modelBuilder.Entity("PawShelter.Accounts.Domain.Accounts.VolunteerAccount", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Experience", "PawShelter.Accounts.Domain.Accounts.VolunteerAccount.Experience#Experience", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("PawShelter.Accounts.Domain.User", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("FullName", "PawShelter.Accounts.Domain.User.FullName#FullName", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("PawShelter.Accounts.Domain.Accounts.ParticipantAccount", b =>
                {
                    b.HasOne("PawShelter.Accounts.Domain.User", "User")
                        .WithOne()
                        .HasForeignKey("PawShelter.Accounts.Domain.Accounts.ParticipantAccount", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("PawShelter.Accounts.Domain.Accounts.VolunteerAccount", b =>
                {
                    b.HasOne("PawShelter.Accounts.Domain.User", "User")
                        .WithOne()
                        .HasForeignKey("PawShelter.Accounts.Domain.Accounts.VolunteerAccount", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
