...
public class UpdateMainInfoCommandValidator : AbstractValidator<UpdateMainInfoCommand>
{
    public UpdateMainInfoCommandValidator()
    {
        ...
        RuleFor(u => u.MainInfoDto.FullName).
            MustBeValueObject(f => 
                FullName.Create(f.FirstName, f.MiddleName, f.LastName));
        
        RuleFor(u => u.MainInfoDto.Description).
            MustBeValueObject(Description.Create);
        
        RuleFor(u => u.MainInfoDto.Email).
            MustBeValueObject(Email.Create);
        
        RuleFor(u => u.MainInfoDto.PhoneNumber).
            MustBeValueObject(PhoneNumber.Create);
        
        RuleFor(u => u.MainInfoDto.Experience).
